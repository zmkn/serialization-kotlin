...
val projectInfo = mapOf(
    "jackson-kotlin" to mapOf(
        "name" to "Kotlin Jackson",
        "description" to "Jackson from Zmkn",
        "tags" to listOf("kotlin", "jackson")
    ),
)
            ...
            publications {
                create<MavenPublication>("mavenJava") {
                    ...
                    pom {
                        ...
                        url.set("https://github.com/zmkn/serialization-kotlin")
                        inceptionYear.set("2025")
                        licenses {
                            license {
                                name.set("MIT License")
                                url.set("https://github.com/zmkn/serialization-kotlin/blob/master/LICENSE")
                            }
                        }
                        developers {
                            developer {
                        ...
                        scm {
                            connection.set("scm:git:https://github.com/zmkn/serialization-kotlin.git")
                            developerConnection.set("scm:git:git@github.com:zmkn/serialization-kotlin.git")
                            url.set("https://github.com/zmkn/serialization-kotlin")
                        }
                    }
                }
    ...
    if (localProperties.getProperty("jreleaser.enable") == "true" && project.name != rootProject.name) {
        ...
        configure<JReleaserExtension> {
            ...
            project {
                ...
                links {
                    homepage.set("https://github.com/zmkn/serialization-kotlin")
                    documentation.set("https://github.com/zmkn/serialization-kotlin/wiki")
                    license.set("https://github.com/zmkn/serialization-kotlin/blob/master/LICENSE")
                    bugTracker.set("https://github.com/zmkn/serialization-kotlin/issues")
                    donation.set("https://github.com/zmkn/serialization-kotlin")
                }
            }
            signing {
                ...
                maven {
                    github {
                        create("github") {
                            ...
                            url.set("https://maven.pkg.github.com/zmkn/serialization-kotlin")
